	...
	<view>
		...
		<view v-else-if="!detail.isbuy" class="animate__animated animate__fadeIn animate__faster">
			<view class="position-relative">
				...
				<view class="position-absolute top-0 left-0 right-0 bottom-0 text-white flex flex-column align-center justify-center" style="background-color: rgba(0, 0, 0, 0.5);">
